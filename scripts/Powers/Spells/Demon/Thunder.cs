...
datablock ShockLanceProjectileData(HeavyShockSpell) {
   directDamage        = 1.1;
   ...
   impulse = 1800;
   boltLength = 60.0;
   extension = 55.0;            // script variable indicating distance you can shock people from
   lightningFreq = 25.0;
...
function HeavyShockSpell::DoShockEffect(%dat, %p, %obj, %hitObj) {
